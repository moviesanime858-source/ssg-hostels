...
export function TransportSchedule({ morningTrips, returnTrips }: TransportScheduleProps) {
  return (
        ...
        <CardHeader className="bg-teal-50 pb-4 border-b border-teal-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-teal-700 font-medium">Pickup: Hostel Mess</p>
            </div>
          </div>
        </CardHeader>
          ...
          <ul className="grid grid-cols-2 gap-3 sm:grid-cols-2">
            {morningTrips.map((trip) => (
              ...
              >
                ...
                <span className="font-semibold text-slate-700">{trip.time}</span>
              </li>
            ))}
          </ul>
        </CardContent>
        ...
        <CardHeader className="bg-indigo-50 pb-4 border-b border-indigo-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-indigo-700 font-medium">Pickup: VIT-AP Main Gate</p>
            </div>
          </div>
        </CardHeader>
        <CardContent className="pt-6">
